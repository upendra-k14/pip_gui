...
from pip_tkinter._vendor import six
from pip_tkinter._vendor.six.moves import urllib, map
...
from pip_tkinter._vendor import packaging
__import__('pip_tkinter._vendor.packaging.version')
__import__('pip_tkinter._vendor.packaging.specifiers')
